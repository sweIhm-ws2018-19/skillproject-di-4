...
public class AlgorithmenUndDatenstrukturenTest {
	...
	public boolean testGetFragen() {
		...
		for(int i=0; i < AlgorithmenUndDatenstrukturen.alleFragen.length;i++) {
			...
			if((AlgorithmenUndDatenstrukturen.alleFragen[i][0]+" Die Antwortmoeglichkeiten sind: "+AlgorithmenUndDatenstrukturen.alleFragen[i][1]).equals(fragen.get(j).getFrage()) && 
