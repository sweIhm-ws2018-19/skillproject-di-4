...
public class TheoretischeInformatik extends Kurs {
	...
	public static final String beschreibung = "Das Ziel des Faches Theoretische Informatik ist es den Studierenden "
			+ "eine Einfuehrung in Automatentheorie, formale Spracehn und " + "Berechenbarkeitstheorie zu geben.";
